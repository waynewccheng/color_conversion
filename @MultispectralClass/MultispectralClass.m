...
classdef MultispectralClass
    ...
    methods (Static)
        ...
        register_controlpoint_show (original_fn, unregistered_fn, folder_output)
    ...
    methods (Static)
        ...
        %
        %
        function register_zeiss (pathname)
            path_truth = [pathname '/truth/900 sRGB/truth.tif']
            path_zeiss_roi = [pathname '/zeiss/200 roi/zeiss.tif']
            path_zeiss_reg = [pathname '/zeiss/400 sRGB']
            
%            MultispectralClass.register_controlpoint_save(path_truth,path_zeiss_roi,path_zeiss_reg)
            MultispectralClass.register_controlpoint_show(path_truth,path_zeiss_roi,path_zeiss_reg)
%            MultispectralClass.check_registration_with_bars(path_zeiss_reg)
